...
function makeTodo(BookshelfObject) {
    ...
    if (BookshelfObject.bookIsCompleted) {
        ...
        undoButton.innerHTML = "Not finished reading";
        ...
        function undoTaskFromCompleted(todoId) {
          if (confirm("Have you not finished reading this book yet?")){
        ...
        trashButton.innerHTML = "Delete book";
        ...
        checkButton.innerHTML = "Done reading";
